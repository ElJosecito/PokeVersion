    ...
    <Provider store={store}>
      <header className="w-full h-16 flex items-center px-5 fixed  bg-blue-500 z-50">
        <div className="max-w-screen-xl w-full h-full flex items-center">
          <h1 className="text-2xl font-bold text-white">PokeVersion</h1>
        </div>
        <ul className="flex items-center">
          {render === 1 ? (
            <>
              <li className="mx-3 text-xl font-bold text-white transition-colors duration-200 hover:text-[#22223B]">
